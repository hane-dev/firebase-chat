 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(A,V){var W=A.length;A.push(V);e:for(;0<W;){var Se=W-1>>>1,Ne=A[Se];if(0<i(Ne,V))A[Se]=V,A[W]=Ne,W=Se;else break e}}function n(A){return A.length===0?null:A[0]}function r(A){if(A.length===0)return null;var V=A[0],W=A.pop();if(W!==V){A[0]=W;e:for(var Se=0,Ne=A.length,is=Ne>>>1;Se<is;){var _t=2*(Se+1)-1,vr=A[_t],gn=_t+1,ss=A[gn];if(0>i(vr,W))gn<Ne&&0>i(ss,vr)?(A[Se]=ss,A[gn]=W,Se=gn):(A[Se]=vr,A[_t]=W,Se=_t);else if(gn<Ne&&0>i(ss,W))A[Se]=ss,A[gn]=W,Se=gn;else break e}}return V}function i(A,V){var W=A.sortIndex-V.sortIndex;return W!==0?W:A.id-V.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,h=null,d=3,f=!1,m=!1,y=!1,w=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(A){for(var V=n(u);V!==null;){if(V.callback===null)r(u);else if(V.startTime<=A)r(u),V.sortIndex=V.expirationTime,e(l,V);else break;V=n(u)}}function _(A){if(y=!1,v(A),!m)if(n(l)!==null)m=!0,Ht(E);else{var V=n(u);V!==null&&jn(_,V.startTime-A)}}function E(A,V){m=!1,y&&(y=!1,g(R),R=-1),f=!0;var W=d;try{for(v(V),h=n(l);h!==null&&(!(h.expirationTime>V)||A&&!ie());){var Se=h.callback;if(typeof Se=="function"){h.callback=null,d=h.priorityLevel;var Ne=Se(h.expirationTime<=V);V=t.unstable_now(),typeof Ne=="function"?h.callback=Ne:h===n(l)&&r(l),v(V)}else r(l);h=n(l)}if(h!==null)var is=!0;else{var _t=n(u);_t!==null&&jn(_,_t.startTime-V),is=!1}return is}finally{h=null,d=W,f=!1}}var C=!1,S=null,R=-1,K=5,N=-1;function ie(){return!(t.unstable_now()-N<K)}function Ce(){if(S!==null){var A=t.unstable_now();N=A;var V=!0;try{V=S(!0,A)}finally{V?$e():(C=!1,S=null)}}else C=!1}var $e;if(typeof p=="function")$e=function(){p(Ce)};else if(typeof MessageChannel<"u"){var jt=new MessageChannel,Wt=jt.port2;jt.port1.onmessage=Ce,$e=function(){Wt.postMessage(null)}}else $e=function(){w(Ce,0)};function Ht(A){S=A,C||(C=!0,$e())}function jn(A,V){R=w(function(){A(t.unstable_now())},V)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(A){A.callback=null},t.unstable_continueExecution=function(){m||f||(m=!0,Ht(E))},t.unstable_forceFrameRate=function(A){0>A||125<A?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):K=0<A?Math.floor(1e3/A):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(A){switch(d){case 1:case 2:case 3:var V=3;break;default:V=d}var W=d;d=V;try{return A()}finally{d=W}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(A,V){switch(A){case 1:case 2:case 3:case 4:case 5:break;default:A=3}var W=d;d=A;try{return V()}finally{d=W}},t.unstable_scheduleCallback=function(A,V,W){var Se=t.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?Se+W:Se):W=Se,A){case 1:var Ne=-1;break;case 2:Ne=250;break;case 5:Ne=1073741823;break;case 4:Ne=1e4;break;default:Ne=5e3}return Ne=W+Ne,A={id:c++,callback:V,priorityLevel:A,startTime:W,expirationTime:Ne,sortIndex:-1},W>Se?(A.sortIndex=W,e(u,A),n(l)===null&&A===n(u)&&(y?(g(R),R=-1):y=!0,jn(_,W-Se))):(A.sortIndex=Ne,e(l,A),m||f||(m=!0,Ht(E))),A},t.unstable_shouldYield=ie,t.unstable_wrapCallback=function(A){var V=d;return function(){var W=d;d=V;try{return A.apply(this,arguments)}finally{d=W}}}})(dE);(function(t){t.exports=dE})(hE);/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const S_=new Tl("@firebase/auth");function Qu(t,...e){S_.logLevel<=ne.ERROR&&S_.error(`Auth (${Jr}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ji=new Tl("@firebase/firestore");function Mw(){return ji.logLevel}function M(t,...e){if(ji.logLevel<=ne.DEBUG){const n=e.map(Yy);ji.debug(`Firestore (${Ro}): ${t}`,...n)}}function hr(t,...e){if(ji.logLevel<=ne.ERROR){const n=e.map(Yy);ji.error(`Firestore (${Ro}): ${t}`,...n)}}function Lw(t,...e){if(ji.logLevel<=ne.WARN){const n=e.map(Yy);ji.warn(`Firestore (${Ro}): ${t}`,...n)}}function Yy(t){if(typeof t=="string")return t;try{return e=t,JSON.stringify(e)}catch{return t}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
